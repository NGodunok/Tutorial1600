...
<p>The purpose of this tutorial is providing an entry into web development for people who want a platform to explore and experiment code on. The linked pages give more details on how to change the live server port and the other walks through creating a JavaScript file. </p>
...
[Live Server Port Configuration](PortConfiguration.md)&nbsp;&nbsp;&nbsp;&nbsp;[JavaScript walkthrough](JavascriptWalkthrough.md) 
